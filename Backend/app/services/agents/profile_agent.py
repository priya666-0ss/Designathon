...
from tools.profile_tools import profile_functions
from dotenv import load_dotenv

load_dotenv()  # Ensure your connection string is stored here

def profile_agent(agent_id: str, prompt: str):
    """
    ...
    functions = FunctionTool(profile_functions)  # Add your custom functions
    toolset = ToolSet()
...
if __name__ == "__main__":
    ...
    user_prompt = ""
    profile_agent(agent_id, user_prompt)
